...
export const loans = <i className="fa-solid fa-graduation-cap" aria-hidden="true"></i>
export const car = <i className="fa-solid fa-car" aria-hidden="true"></i>
export const utilities = <i className="fa-solid fa-shower" aria-hidden="true"></i>
export const user = <i className="fa-solid fa-user-o" aria-hidden="true"></i>
export const house = <i className="fa-solid fa-home" aria-hidden="true"></i>
export const plane = <i className="fa-solid fa-plane" aria-hidden="true"></i>
export const glass = <i class="fa fa-glass" aria-hidden="true"></i>
export const phone = <i class="fa fa-mobile" aria-hidden="true"></i>
export const computer = <i class="fa fa-laptop" aria-hidden="true"></i>
export const play = <i class="fa fa-play" aria-hidden="true"></i>
